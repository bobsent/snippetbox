...
func (m *UserModel) Insert(name, email, password string) error {
	...
	// We can check whether or not the error relates to our users_uc_email key by checking if the error
	// code equals 1062 and the contents of the error message string.
...
// We'll use the Exists method to check if a user exists with a specifi ID.
