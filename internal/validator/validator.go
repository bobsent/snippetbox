...
// CheckField() adds en error message to the FieldErrors map only if a validation check is
// not 'ok'
...
// MaxChars() returns true if a value is no more than n characters
func MaxChars(value string, n int) bool {
	return utf8.RuneCountInString(value) <= n
}

// PermittedValue returs true if the value type of T equals one of the variadic
